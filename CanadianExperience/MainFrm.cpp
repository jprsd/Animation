...
void CMainFrame::Initialize()
{
	...
	mPicture->SetTreeDrawables(factory.GetTreeDrawable1(), factory.GetTreeDrawable2());
	...
	// Tell the timeline view about the tree drawables
	mViewTimeline->SetTreeDrawables(factory.GetTreeDrawable1(), factory.GetTreeDrawable2());
